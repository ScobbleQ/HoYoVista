...
// import { addAttemptedCode, addEvent } from '../db/queries.js';
...
// import { APP_HEADER, GAME_BIZS, GameIconUrl, REDEEM_URL } from './routes.js';

// /**
//  *
//  * @param {string} id - The Discord UID
...
//   id,
//   availableCodes,
//   { arrayOfGameId, hoyolabCookies, linkedGames, isPrivate, toNotify, automatic, collectData }
// ) => {
//   const e = await postRedeem(linkedGames.gameId, id, linkedGames.region, availableCodes, {
//     ltmid_v2: hoyolabCookies.ltmidV2,
//     ltoken_v2: hoyolabCookies.ltokenV2,
//     ltuid_v2: hoyolabCookies.ltuidV2,
...
//   const linkedGamesMap = Object.fromEntries(
//     Object.values(linkedGames).map((game) => [game.game_id, game])
//   );
...
//         //     value: code.code,
//         // });
//         await addAttemptedCode(id, gameId, code.code);
