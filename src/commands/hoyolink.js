...
export default {
	...
	async execute(interaction) {
		...
		const embed = createEmbed('No HoYoLAB account linked. Press the button below to get started.', embedColors.primary);
	...
	async handleButtonClick(interaction) {
		...
		if (button === 'add') {
			...
			const sampleCookies = 'ltmid_v2=____; ltoken_v2=v2____; ltuid_v2=____; DEVICEFP=____; HYV_LOGIN_PLATFORM_LIFECYCLE_ID={}; HYV_LOGIN_PLATFORM_LOAD_TIMEOUT={}; HYV_LOGIN_PLATFORM_TRACKING_MAP={}; _HYVUUID=____; _MHYUUID=____; mi18nLang=en-us; account_id_v2=____; account_mid_v2=____; cookie_token_v2=v2____; HYV_LOGIN_PLATFORM_OPTIONAL_AGREEMENT={}';
	...
	async handleModalSubmit(interaction) {
		...
		const embed = createEmbed('Your HoYoLAB account has been successfully linked. All game records have been updated and linked to your profile.', embedColors.success);
