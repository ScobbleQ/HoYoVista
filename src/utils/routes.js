...
export const GAME_ICON_URL = Object.freeze({
	[Game.GENSHIN]: 'https://fastcdn.hoyoverse.com/static-resource-v2/2023/11/08/9db76fb146f82c045bc276956f86e047_6878380451593228482.png',
	[Game.STARRAIL]: 'https://hyl-static-res-prod.hoyolab.com/communityweb/business/starrail_hoyoverse.png',
	[Game.HONKAI]: 'https://fastcdn.hoyoverse.com/static-resource-v2/2024/11/28/661dc2b424af6cb14b5bd675c67c2d8c_4476105097458126091.png',
...
export const APP_HEADER = ({ ltmid_v2, ltoken_v2, ltuid_v2, mi18nLang }) => {
	const header = {
		'Accept-Encoding': 'gzip, deflate, br',
		'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) miHoYoBBSOversea/3.3.1',
		'Referer': DEFAULT_REFERER,
		'Cookie': `ltmid_v2=${ltmid_v2}; ltoken_v2=${ltoken_v2}; ltuid_v2=${ltuid_v2}; mi18nLang=${mi18nLang}; account_id_v2=${ltuid_v2}; account_mid_v2=${ltmid_v2}`,
		'Origin': DEFAULT_ORIGIN,
...
export const CHECKIN_DETAILS_URL = ({ type, game, lang }) => `${getEventBaseUrl(game)}/event/${EVENTS[game]}/${type}?lang=${lang}&act_id=${ACT_IDS[game]}`;
